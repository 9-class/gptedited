...
openai.api_key = "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"
...
Please keep this information in mind and generate a prompt about  """ + input}
    ...
    data = {
        "key": "R0sL0CYpZRx0gDySVDCKNiEvXBVepwSmwS66piZTpx7QmphthU9x07Lm8K9Q",
...
st.title('ChatGPT Edited')
st.subheader(
    'chatGPT which generates images,analyse prices')
